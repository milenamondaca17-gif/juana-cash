...
class ProductosScreen(QWidget):
    ...
    def mostrar_productos(self, productos, es_filtro=False):
        ...
        for i, p in enumerate(mostrar):
            ...
            btn_edit.setStyleSheet("QPushButton { background: transparent; color: white; border: 1px solid #3498db; border-radius: 6px; font-size: 13px; } QPushButton:hover { background: #3498db; }")
            btn_edit.clicked.connect(lambda _, idx=i: self.editar_producto(idx))
            btn_l.addWidget(btn_edit)

            btn_ajuste = QPushButton("📦")
            btn_ajuste.setFixedSize(30, 28)
            btn_ajuste.setToolTip("Ajustar stock")
            btn_ajuste.setStyleSheet("QPushButton { background: transparent; color: white; border: 1px solid #27ae60; border-radius: 6px; font-size: 13px; } QPushButton:hover { background: #27ae60; }")
            ...
            btn_borrar.setStyleSheet("QPushButton { background: transparent; color: white; border: 1px solid #e74c3c; border-radius: 6px; font-size: 13px; } QPushButton:hover { background: #e74c3c; }")
