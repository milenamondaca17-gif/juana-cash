...
class ProductosScreen(QWidget):
    ...
    def mostrar_productos(self, productos, es_filtro=False):
        ...
        for i, p in enumerate(mostrar):
            ...
            btn_edit.setStyleSheet("QPushButton { background: #2563EB; color: white; border: none; border-radius: 5px; font-size: 10px; font-weight: bold; padding: 0 8px; } QPushButton:hover { background: #1D4ED8; }")
            btn_edit.clicked.connect(lambda _, idx=i: self.editar_producto(idx))
            btn_l.addWidget(btn_edit)

            btn_ajuste = QPushButton("Stock")
            btn_ajuste.setFixedHeight(26)
            btn_ajuste.setToolTip("Ajustar stock")
            btn_ajuste.setStyleSheet("QPushButton { background: #16A34A; color: white; border: none; border-radius: 5px; font-size: 10px; font-weight: bold; padding: 0 8px; } QPushButton:hover { background: #15803D; }")
            ...
            btn_borrar.setToolTip("Eliminar producto")
            btn_borrar.setStyleSheet("QPushButton { background: #DC2626; color: white; border: none; border-radius: 5px; font-size: 10px; font-weight: bold; padding: 0 8px; } QPushButton:hover { background: #B91C1C; }")
