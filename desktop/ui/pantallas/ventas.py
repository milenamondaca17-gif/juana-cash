    ...
    def actualizar_tabla(self):
        ...
        for i, item in enumerate(self.items_venta):
            ...
            if self.tabla.cellWidget(i, 4) is None:
                ...
                btn_mas.setStyleSheet("QPushButton { background: #DCFCE7; color: #16A34A; border-radius: 6px; font-size: 20px; font-weight: bold; border: 1.5px solid #86EFAC; } QPushButton:hover { background: #16A34A; color: white; border-color: #16A34A; }")
