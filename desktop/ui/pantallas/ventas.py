    ...
    def actualizar_tabla(self):
        ...
        for i, item in enumerate(self.items_venta):
            ...
            if self.tabla.cellWidget(i, 4) is None:
                ...
                btn_menos.setStyleSheet("QPushButton { background:#DC2626; color:white; border-radius:6px; font-size:22px; font-weight:900; border:none; } QPushButton:hover { background:#B91C1C; color:white; }")
                ...
                btn_mas.setStyleSheet("QPushButton { background:#16A34A; color:white; border-radius:6px; font-size:22px; font-weight:900; border:none; } QPushButton:hover { background:#15803D; color:white; }")
                ...
                btn_del.setStyleSheet("QPushButton { background:#DC2626; color:white; border-radius:6px; font-size:18px; font-weight:900; border:none; } QPushButton:hover { background:#B91C1C; color:white; }")
