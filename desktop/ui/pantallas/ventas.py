    ...
    def actualizar_tabla(self):
        ...
        for i, item in enumerate(self.items_venta):
            ...
            if self.tabla.cellWidget(i, 4) is None:
                ...
                btn_menos.setStyleSheet(f"QPushButton#qtyMinus{i} {{ background:#F1F5F9; color:#DC2626; border-radius:6px; border:1.5px solid #94A3B8; font-size:20px; font-weight:bold; }} QPushButton#qtyMinus{i}:hover {{ background:#FEE2E2; border-color:#FCA5A5; }}")
                ...
                btn_mas.setStyleSheet(f"QPushButton#qtyPlus{i} {{ background:#F1F5F9; color:#16A34A; border-radius:6px; border:1.5px solid #94A3B8; font-size:20px; font-weight:bold; }} QPushButton#qtyPlus{i}:hover {{ background:#DCFCE7; border-color:#86EFAC; }}")
                ...
                btn_del.setStyleSheet(f"QPushButton#qtyDel{i} {{ background:#F1F5F9; color:#DC2626; border-radius:6px; border:1.5px solid #94A3B8; font-size:16px; font-weight:bold; }} QPushButton#qtyDel{i}:hover {{ background:#FEE2E2; border-color:#FCA5A5; }}")
